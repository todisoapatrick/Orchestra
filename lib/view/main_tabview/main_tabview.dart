...
import 'package:orchestra/view/settings/settings_view.dart';
import 'package:orchestra/view/songs/songs_view.dart';
      ...
      drawer: Drawer(
          ...
          child: ListView(
            ...
            children: [
              ...
              IconTextRow(
                title: "Coupeur de sonnerie",
                icon: "assets/img/m_ring_cut.png",
                onTap: () {},
              ),

              IconTextRow(
                title: "Timer de veille",
